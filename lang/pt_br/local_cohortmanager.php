...
/**
 * Portuguese language pack for Cohort Manager
 *
...
$string['pluginname'] = 'Gerenciador de Coortes';
...
$string['createnewcohort'] = 'Adicionar Nova';
...
$string['instanceexists'] = 'Já existe uma instância de inscrição com esta coorte e papel no curso. Tente outro papel.';
...
$string['reset'] = 'Limpar';
$string['creating'] = 'Adicionando...';
$string['createcohort'] = 'Adicionar';
$string['failedtocreatecohort'] = 'Falha ao adicionar. Tente novamente.';
$string['resetform'] = 'Limpar Formulário';
$string['pleaseentercohortname'] = 'Digite um nome';
$string['pleaseenteridnumber'] = 'Digite um nº ID';
$string['cohortcreatedsuccessfully'] = 'Adicionada com sucesso';
...
$string['cohortportrait'] = 'Retrato da Coorte';
$string['members'] = 'Membros';
$string['memberscount'] = 'membros';
$string['enrolinstances'] = 'Instâncias de Inscrição';
$string['totalenrolments'] = 'Total de Inscritos';
$string['roleassignments'] = 'Atribuições de Papéis';
...
$string['nomembersfounddescription'] = 'Nenhum membro encontrado nesta coorte. Adicione membros para começar.';
...
$string['selectcontext'] = 'Selecionar contexto';
...
$string['customfieldssaved'] = 'Campos personalizados salvos com sucesso.';
$string['errorprocessingcustomfields'] = 'Erro ao processar campos personalizados. Tente novamente.';
$string['customfieldnotvalid'] = 'Campos personalizados inválidos.';
...
$string['addenrolinstance'] = 'Adicionar Instância de Inscrição';
$string['cohortenrolinstances'] = 'Instâncias de Inscrição';
$string['instancescount'] = 'instâncias de inscrição';
$string['loadingenrolinstances'] = 'Carregando instâncias de inscrição...';
$string['noenrolinstancesfound'] = 'Nenhuma Instância de Inscrição Encontrada';
$string['noenrolinstancesfounddescription'] = 'Nenhuma instância de inscrição encontrada.';
$string['enrolinstanceslist'] = 'Instâncias de Inscrição';
...
$string['deleteenrolinstance'] = 'Excluir instância de inscrição';
$string['deleteenrolinstanceconfirmation'] = 'Tem certeza de que deseja excluir a instância de inscrição para "%s"?';
$string['deleteenrolinstancewarning'] = 'Aviso: Isso removerá {$a} inscrições de usuários deste curso.';
$string['enrolinstancedeletedsuccessfully'] = 'Instância de inscrição excluída com sucesso';
$string['searchenrolinstances'] = 'Buscar instâncias de inscrição...';
$string['filterbystatus'] = 'Filtrar por status';
$string['all'] = 'Todos';
$string['togglestatus'] = 'Alternar status';
$string['enrolinstancestatusupdated'] = 'Status da instância de inscrição atualizado com sucesso';
$string['errortogglingstatus'] = 'Erro ao atualizar status da instância de inscrição';
$string['enrolinstanceupdated'] = 'Instância de inscrição atualizada com sucesso';

// Roles management component strings
$string['rolesmanagement'] = 'Administração de Papéis';
$string['usercontextroles'] = 'Papéis no Contexto do Usuário';
$string['searchroles'] = 'Buscar papéis...';
$string['loadingroles'] = 'Carregando papéis...';
...
$string['rolenotfound'] = 'Papel não encontrado';
$string['roleexists'] = 'Já existe um papel com este nome curto';
$string['noassignableroles'] = 'Nenhum papel atribuível disponível no contexto do usuário.';
...
$string['rolecreate'] = 'Criar Papel';
$string['roleupdate'] = 'Atualizar Papel';
$string['roledeleteconfirmation'] = 'Tem certeza que deseja excluir "%s"? Esta ação não pode ser desfeita.';
$string['deletethisrole'] = 'Excluir este papel';
$string['cannotdeletethisrole'] = 'Este papel não pode ser excluído pois é do sistema.';
$string['cannotdeleterolewithid'] = 'Não é possível excluir o papel com ID {$a}.';
$string['rolesearchplaceholder'] = 'Buscar por nome, nome curto ou personalizado...';
$string['rolescount'] = 'papéis';
$string['norolesfound'] = 'Nenhum papel encontrado';
$string['norolesfounddesc'] = 'Nenhum papel encontrado.';
$string['createyourfirstrole'] = 'Crie seu primeiro papel para começar.';
...
$string['enrolinstanceadded'] = 'Instância de inscrição adicionada com sucesso';
$string['errorcreatingenrolinstances'] = 'Erro ao criar instâncias de inscrição. Tente novamente.';

// Cohort role assignments (tool_cohortroles integration) strings
$string['cohortroles'] = 'Papéis da Coorte';
...
$string['noroughassignmentsfounddescription'] = 'Nenhuma atribuição encontrada. Atribua usuários com papéis para estabelecer hierarquia.';
...
$string['assignroletouser'] = 'Atribuir Papel';
